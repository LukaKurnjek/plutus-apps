...
import Plutus.Contract.ChainIndex.Tx (ChainIndexTx (ChainIndexTx), ChainIndexTxOut (..), ChainIndexTxOutputs (..),
...
import Plutus.Contract.ChainIndex.Types (BlockId (BlockId), BlockNumber (BlockNumber),
                                         Tip (Tip, tipBlockId, tipBlockNo, tipSlot), TxIdState, TxOutBalance,
                                         TxUtxoBalance)
